...
//         <TabsProvider
//           defaultValue="choose"
//           className="md:grid md:grid-cols-12 items-start justify-center gap-8">
...
//                 <TabHeader 
//                   value={tab.id} 
//                   className="w-full text-left p-4 rounded-lg border border-gray-200 hover:border-[#0085c3] transition-all duration-300 cursor-pointer group"
//                 >
//                   <h3 className="text-lg font-semibold text-gray-900 group-hover:text-[#0085c3] transition-colors duration-300">
//                     {tab.title}
//                   </h3>
//                 </TabHeader>
                
//                 <TabDes value={tab.id} className="mt-4">
//                   <div className="bg-gray-50 border border-gray-200 rounded-lg overflow-hidden">
//                     <p className="text-gray-700 p-6 leading-relaxed">
//                       {tab.description}
//                     </p>
//                     {/* Mobile image */}
//                     <img
//                       src={tab.imageUrl}
//                       alt={tab.title}
//                       className="md:hidden block w-full h-48 object-cover"
//                     />
//                   </div>
//                 </TabDes>
//               </TabItem>
    ...
    <section className="w-full bg-white py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="max-w-7xl mx-auto">
        <TabsProvider
          ...
          {/* Desktop Images - Hidden on mobile, visible on large screens */}
