        ...
        <div className="wrapper">
            ...
            <div className="absolute bottom-20 left-40 z-20">
              <div className="flex">
                <div className="animate-bounce">
                  <svg className="w-10 h-10 text-[#0085c3]" fill="currentColor" viewBox="0 0 24 24">
          ...
          <section className="relative text-gray-900 h-screen w-full bg-black grid place-content-center sticky top-0 overflow-hidden">
            ...
            <div className="relative z-10 max-w-7xl px-8 mx-auto text-center">
              {/* Improved Headline */}
              <div className="mb-6">
                <h1 className="text-5xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tight leading-[110%] mb-8">
